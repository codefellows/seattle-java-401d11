...
public final class ShoppingItem implements Model {
  ...
  public static final QueryField PRODUCT_LATITUDE = field("ShoppingItem", "productLatitude");
  public static final QueryField PRODUCT_LONGITUDE = field("ShoppingItem", "productLongitude");
  public static final QueryField PRODUCT_CITY = field("ShoppingItem", "productCity");
  ...
  private final @ModelField(targetType="String") String productCity;
  ...
  private ShoppingItem(String id, String itemName, Temporal.DateTime timeAdded, String productCategory, BusinessUnit businessUnit, String productImageKey, String productLatitude, String productLongitude, String productCity) {
    this.id = id;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), shoppingItem.getId()) &&
              ...
              ObjectsCompat.equals(getProductLatitude(), shoppingItem.getProductLatitude()) &&
              ObjectsCompat.equals(getProductLongitude(), shoppingItem.getProductLongitude()) &&
              ObjectsCompat.equals(getProductCity(), shoppingItem.getProductCity()) &&
  ...
  @Override
   public String toString() {
    return new StringBuilder()
      ...
      .append("productCity=" + String.valueOf(getProductCity()) + ", ")
  ...
  public interface BuildStep {
    ...
    BuildStep productCity(String productCity);
  }
  ...
  public static class Builder implements BusinessUnitStep, BuildStep {
    ...
    @Override
     public BuildStep productCity(String productCity) {
        this.productCity = productCity;
        return this;
    }
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String itemName, Temporal.DateTime timeAdded, String productCategory, BusinessUnit businessUnit, String productImageKey, String productLatitude, String productLongitude, String productCity) {
      super.id(id);
    ...
    @Override
     public CopyOfBuilder productCity(String productCity) {
      return (CopyOfBuilder) super.productCity(productCity);
    }
  }
